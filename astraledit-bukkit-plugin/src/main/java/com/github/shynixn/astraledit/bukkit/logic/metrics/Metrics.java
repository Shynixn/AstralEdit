package com.github.shynixn.astraledit.bukkit.logic.metrics;
    ...
    public static abstract class CustomChart {
        ...
        private JSONObject getRequestJsonObject() {
            ...
            try {
                ...
                if (logFailedRequests) {
                    AstralEditPlugin.logger().log(Level.WARNING, "Failed to get data for custom chart with id " + this.chartId, t);
                }
                return null;
            }
            return chart;
